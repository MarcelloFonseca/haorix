              ...
              <div className="rounded-2xl bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 shadow-sm dark:shadow-none p-6 sm:p-8 space-y-8">
                <div className="flex items-center justify-between p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className={`${montserrat.className} text-sm font-medium text-black dark:text-white`}>Test Test</div>
                      <div className={`${montserrat.className} text-xs text-zinc-500`}>Test test test</div>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-zinc-200 dark:bg-white/5 border border-zinc-300 dark:border-zinc-700 flex items-center justify-center">
                      <div className={`${michroma.className} text-sm font-bold text-black dark:text-white`}>AX</div>
                    </div>
                    <div>
                      <div className={`${montserrat.className} text-sm font-medium text-black dark:text-white`}>Test</div>
                      <div className={`${montserrat.className} text-xs text-zinc-500`}>Test test test</div>
                    </div>
                  </div>
                  <div className={`${montserrat.className} text-xs text-zinc-500`}>Test</div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2 pt-4 border-t border-zinc-200 dark:border-zinc-800">
                  <div className="flex flex-col items-center gap-1 p-2">
                    ...
                    <div className={`${montserrat.className} text-xs text-zinc-400 dark:text-zinc-600`}>Test</div>
                  </div>
                  <div className="flex flex-col items-center gap-1 p-2">
            ...
            <div className="lg:order-1 relative w-full max-w-xl lg:max-w-none mx-auto">
              <div className="rounded-2xl bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 shadow-sm dark:shadow-none p-6 space-y-4">
                ...
                <div className="space-y-3">
                  <div className={`${montserrat.className} text-xs text-zinc-500 font-medium uppercase tracking-wide`}>Test Test</div>
                  <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800">
                    <div className="flex items-start justify-between">
                      <div className="space-y-1">
                        <div className={`${montserrat.className} text-sm font-medium text-black dark:text-white`}>Test Test Test</div>
                        <div className={`${montserrat.className} text-xs text-zinc-500`}>Test test test</div>
                      </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    {[
                      { module: "Test Test", access: "Test/Test" },
                      { module: "Test Test", access: "Test Test" },
                      { module: "Test", access: "Test" },
                    ].map((item, i) => (
                      <div key={i} className={`${montserrat.className} flex items-center justify-between px-3 py-2.5 rounded-lg bg-zinc-50 dark:bg-zinc-900/30 border border-zinc-200 dark:border-zinc-800/50 text-xs`}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-3 rounded-lg bg-zinc-50 dark:bg-zinc-900/30 border border-zinc-200 dark:border-zinc-800/50 space-y-2">
                    <div className={`${montserrat.className} flex items-center justify-between text-xs`}>
                      ...
                      <span className="text-black dark:text-white font-mono">5 000$</span>
                    </div>
                    <div className={`${montserrat.className} flex items-center justify-between text-xs`}>
                      <span className="text-zinc-600 dark:text-zinc-400">Test test</span>
                      <span className="text-black dark:text-white">Test Test</span>
                    </div>
                    <div className={`${montserrat.className} flex items-center justify-between text-xs`}>
                      <span className="text-zinc-600 dark:text-zinc-400">Test</span>
                      <span className="text-black dark:text-white font-mono">24h</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-2xl bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 shadow-sm dark:shadow-none p-6 space-y-5">
                <div className="flex items-center justify-between pb-4 border-b border-zinc-200 dark:border-zinc-800">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-emerald-500" />
                    <span className={`${montserrat.className} text-xs text-zinc-500`}>Test</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/50 space-y-1">
                    ...
                    <div className={`${montserrat.className} text-xs text-emerald-600 dark:text-emerald-500`}>+12% test</div>
                  </div>
                  <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/50 space-y-1">
                    <div className={`${michroma.className} text-2xl font-bold text-black dark:text-white`}>99.2%</div>
                    <div className={`${montserrat.className} text-xs text-zinc-500`}>Test test</div>
                    <div className={`${montserrat.className} text-xs text-zinc-600`}>Test Test</div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    {[
                      { task: "Test #4892 test", status: "completed", time: "3m" },
                      { task: "Test #2847 test test", status: "pending", time: "5m" },
                      { task: "Test test test test", status: "completed", time: "8m" },
                      { task: "Test test", status: "completed", time: "12m" },
                    ].map((activity, i) => (
                      <div key={i} className={`${montserrat.className} flex items-center gap-3 px-3 py-2 rounded-lg bg-zinc-50 dark:bg-zinc-900/30 border border-zinc-200 dark:border-zinc-800/30 text-xs`}>
                ...
                <div className="pt-3 border-t border-zinc-200 dark:border-zinc-800">
                  <div className={`${montserrat.className} flex items-center justify-between text-xs mb-2`}>
                    <span className="text-zinc-500">Test test</span>
