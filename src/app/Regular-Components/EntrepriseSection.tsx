    ...
    <section className="relative bg-white dark:bg-popover w-full min-h-screen py-16 md:py-24">
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 ${isTabletLandscape && !isDesktop ? 'items-start' : 'items-center'}`}>
          ...
          <div className="space-y-8 order-1 w-full max-w-[90vw] mx-auto lg:max-w-2xl">
            ...
            <h2 className={`${michroma.className} text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-black dark:text-white`}>
              Section pour VizCo. Explication intégration{' '}
              <span className="text-black dark:text-white">VizCo ERP</span>
            </h2>

            <p className={`${montserrat.className} text-base sm:text-lg md:text-xl leading-relaxed text-zinc-600 dark:text-white dark:opacity-80`}>
              Explication un peu plus longue sur l'intégration avec VizCo ERP.
              Continuation de l'explication pour montrer comment HAORIX offre des fonctionnalités
              continuation ici...
            </p>
              ...
              <div className="relative rounded-2xl bg-white border border-zinc-200 shadow-lg dark:bg-gradient-to-br dark:from-zinc-900/80 dark:to-black/80 dark:backdrop-blur-sm dark:border-zinc-800/50 dark:shadow-none p-8 md:p-10">
                ...
                <div className="space-y-6 mb-8">
                  <div className="flex items-center justify-between">
                    <span className={`${montserrat.className} text-base md:text-lg text-zinc-600 dark:text-white dark:opacity-70`}>Fiabilité de la plateforme</span>
                    <span className={`${michroma.className} text-xl md:text-2xl font-bold text-black dark:text-white`}>99.99%</span>
                  </div>

                  <div className="flex items-center justify-between">
                    <span className={`${montserrat.className} text-base md:text-lg text-zinc-600 dark:text-white dark:opacity-70`}>Années d'expertise</span>
                    <span className={`${michroma.className} text-xl md:text-2xl font-bold text-black dark:text-white`}>10+</span>
                  </div>

                  <div className="flex items-center justify-between">
                    <span className={`${montserrat.className} text-base md:text-lg text-zinc-600 dark:text-white dark:opacity-70`}>Clients entreprise</span>
                    <span className={`${michroma.className} text-xl md:text-2xl font-bold text-black dark:text-white`}>1000+</span>
                  </div>

                  <div className="flex items-center justify-between">
                    <span className={`${montserrat.className} text-base md:text-lg text-zinc-600 dark:text-white dark:opacity-70`}>Centres de données</span>
                    <span className={`${michroma.className} text-xl md:text-2xl font-bold text-black dark:text-white`}>Global</span>
                  </div>
                </div>
