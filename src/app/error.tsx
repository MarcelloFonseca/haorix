  ...
  return (
    <div className={`relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background px-4 ${montserrat.className}`}>
      ...
      <div className="relative mb-8 select-none">
        ...
        >
          <span className={isGlitching ? '-translate-x-1 text-muted-foreground' : ''}>5</span>
          ...
          <span className={isGlitching ? 'translate-x-1 text-muted-foreground' : ''}>0</span>
        </div>

        {isGlitching && (
          <>
            <div
              className={`${michroma.className} absolute inset-0 -translate-x-1 text-[100px] font-bold leading-none text-muted-foreground/30 sm:text-[160px] md:text-[200px]`}
            >
              <span className="invisible">5</span>
            </div>
            <div
              className={`${michroma.className} absolute inset-0 translate-x-1 text-[100px] font-bold leading-none text-zinc-500/30 sm:text-[160px] md:text-[200px]`}
            >
              <span className="invisible">5</span>
            </div>
          </>
      ...
      <div className="mb-8 text-center">
        ...
        <p className="max-w-md text-muted-foreground">
          Une erreur s’est produite. Réessayez — si le problème persiste, contactez-nous.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
        ...
        <Button asChild variant="outline" size="lg" className={`${michroma.className} group bg-transparent`}>
          <Link href="/">
      ...
      <div className="mt-12 flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <span>Erreur 500 — on remet la machine en route</span>
      </div>
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute left-[80%] top-[30%] h-1.5 w-1.5 animate-pulse rounded-full bg-zinc-900/60 dark:bg-white/60"
          style={{ animationDelay: '0.5s' }}
        />
        <div
          className="absolute left-[20%] top-[70%] h-1 w-1 animate-pulse rounded-full bg-zinc-900/40 dark:bg-white/40"
          style={{ animationDelay: '1s' }}
        />
        <div
          className="absolute left-[70%] top-[80%] h-1.5 w-1.5 animate-pulse rounded-full bg-zinc-900 dark:bg-white"
          style={{ animationDelay: '1.5s' }}
        />
        <div
          className="absolute left-[90%] top-[50%] h-1 w-1 animate-pulse rounded-full bg-zinc-900/60 dark:bg-white/60"
